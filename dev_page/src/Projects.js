        ...
        <div className="projects">
            ...
            <div className="projects_body">
                ...
                <div className="projects_options">
                    ...
                    <ProjectOption title="OnTrack" vid="/OnTrackVideo.mov" description="Built as a group project, OnTrack is a social media application designed for highschool track coaches and their teams of athletes, built using Flask (Python Back End, MySQL Database) and basic HTML, CSS, and JS on the front end. The app allows for two types of accounts, coach and athlete respectively. Coaches have the ability to create their athletes accounts, post messages to their team, and record track event times which they can later use our hard coded search algorithim to sort through. Athletes can see their team mates times as well as their coaches posts and comment/like each of them respectively. My role on this project was full stack from database design to front end functionality." />
                    <TopButton />
                </div>
            </div>
        </div>
